    ...
    <main>
        ...
        <table class="tablesorter">
            ...
            <tbody>
                ...
                $sql = $pdo->query('select game.game_id,game.game_name,game.game_genre,game.game_model,game.game_stock,game.game_price,bought.game_id,user.user_id from game inner join bought on game.game_id = bought.game_id inner join bought on user.user_id = bought.user_id where user_id = ?');
                $sql->execute();
                foreach ($sql as $row): ?>
                    <tr>
                            <td> <?= $row['game_id'] ?></td>
