    ...
    <main class="complete_main">
        <div class="complete_container">
            ...
            <div class="complete_btn_area">
                <form action="game_add.php" method="post" class="complete_form">
                    <input type=submit value="続けて登録" class="manager_btn">
                </form>
                <form action="home.php" method="post" class="complete_form">
                    <input type=submit value="ホーム画面に戻る" class="manager_btn">
                </form>
            </div>
        </div>
    </main>
